...
public class MegamenuSteps {
	...
	@When("I click move to \\{string\\} menu")
	public void i_click_move_to_menu(String dressMegaMenu) {
		dressesPageActions.moveToMegaMenu(dressMegaMenu);
		//homePageActions.clickOnSignInLink();
	}

	@And("I click on \\{string\\} submenu")
	public void i_click_on_submenu(String dressSubMenu) {
		dressesPageActions.clickDressesSubMenu(dressSubMenu);
	}

	@Then("I should see the \\{string\\} page")
	public void i_should_see_the_page(String expectedText) {
